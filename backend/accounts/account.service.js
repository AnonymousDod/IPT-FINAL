...
async function register(params, origin) {
    console.log('Registration attempt with params:', JSON.stringify(params));
    // validate
    ...
    console.log('Created account with token:', account.verificationToken);
...
async function create(params) {
  ...
  async function update(id, params) {
    ...
    // Remove password fields so they don't overwrite passwordHash
    ...
    console.log('Account after assign', account.toJSON());
